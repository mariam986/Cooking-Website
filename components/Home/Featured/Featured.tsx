              ...
              return (
                ...
                >
                  <Image
                    ...
                    width={600}
                    height={200}
                    className="w-[350px] lg:w-[670px] h-[200px] object-cover  rounded-t-[14px]"
                  />

                  <div className="bg-white flex flex-col h-full rounded-b-[14px] pt-[24px] px-[24px] pb-[16px] space-y-3">
